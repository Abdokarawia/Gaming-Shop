...
class GameDetails extends StatelessWidget {
  static const routename = "goToGameDetailsScreen";
  @override
  Widget build(BuildContext context) {
    ...
    final SelectGame = Provider.of<games>(context).findByID(id);
                      ...
                      Row(
                        ...
                        children: <Widget>[
                          ...
                          Container(
                            ...
                            child: InkWell(
                              onTap: () {
                                cart.addItem(SelectGame.id, SelectGame.price,
                                    SelectGame.title, SelectGame.img);
